    ...
    <div className="h-full flex flex-col">
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">Active Execution</h1>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <motion.div
          ...
          className="w-80 border-r border-slate-800 overflow-y-auto p-4 space-y-3"
        >
            ...
            >
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-slate-400">{exec.id}</span>
                </div>
                <span
                  className={cn(
              ...
              <p className="text-xs text-slate-400 mt-1 text-right">{exec.progress}%</p>
            </motion.div>
          ))}
        </motion.div>
        ...
        <motion.div
          ...
          className="w-96 border-l border-slate-800 flex flex-col"
        >
